...
@export var automatic_scroll: bool = false
@export var scroll_bar: bool = true
...
func _apply_export_overrides() -> void:
	%DialogicNode_DialogText.scroll_following = automatic_scroll
	%DialogicNode_DialogText.scroll_active = scroll_bar
