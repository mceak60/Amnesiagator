...
func _ready() -> void:
	...
	tween.tween_callback(spawn_ingredient_at.bind(preload("res://data/ingredients/mixers/ice.tres"), Vector2i(0, 2)))
	tween.tween_callback(spawn_ingredient_at.bind(preload("res://data/ingredients/mixers/spark_syrup.tres"), Vector2i(1, 2)))
	tween.tween_callback(spawn_ingredient_at.bind(preload("res://data/ingredients/mixers/bubbly_water.tres"), Vector2i(2, 2)))
	tween.tween_callback(spawn_ingredient_at.bind(preload("res://data/ingredients/mixers/lava_lamp.tres"), Vector2i(3, 2)))
	tween.tween_callback(spawn_ingredient_at.bind(preload("res://data/ingredients/garnishes/stardust_sprinkles.tres"), Vector2i(0, 4)))
	tween.tween_callback(spawn_ingredient_at.bind(preload("res://data/ingredients/garnishes/red_pepper_flakes.tres"), Vector2i(1, 4)))
...
func spawn_customer(customer: CustomerDetails) -> void:
